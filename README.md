...
>
> 还在不断更新迭代中，部分功能使用的在线接口api，部分使用的本地存储, 后续有意自己用Python实现后台替换成自己的api;
>
